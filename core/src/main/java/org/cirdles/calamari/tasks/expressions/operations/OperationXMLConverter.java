...
public class OperationXMLConverter implements Converter {
     ...
     * <code>writer</code>
     * @param value   <code>Operation</code> that you wish to write to a
     * file
     ...
     * @post the <code>Operation</code> is read from the XML file and
     * returned
     * @param reader stream to read through
     * @param context <code>UnmarshallingContext</code> used to store generic
     * data
     * @return  <code>Operation</code> - <code>Operation</code>
